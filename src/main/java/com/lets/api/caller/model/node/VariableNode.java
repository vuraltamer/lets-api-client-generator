...
import static com.lets.api.caller.constants.CallerConstants.PARAMETERIZED;
...
public class VariableNode {
    ...
    private static String getParameterizedView(VariableNode node) {
        String view = PARAMETERIZED.replace("{RAW}", node.getSimpleName());
